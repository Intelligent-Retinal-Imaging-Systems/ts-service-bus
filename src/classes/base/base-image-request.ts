...
abstract class BaseImageRequest {
    ...
    public ImageClass: ImageClass; // Declare property without initial value
    public ImageEncoding: ImageEncoding; // Declare property without initial value
    ...
    constructor() {
        ...
        // You may want to initialize ImageClass and ImageEncoding if needed
    }
}
